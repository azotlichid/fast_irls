...
eps = 1/2^i;
tic
[r, f_energy, cnt1] = LoneSolve(B, d, eps, 0);
t1 = toc    

tic
[r, f_energy, cnt2] = LoneSolve(B, d, eps, 1);
t2 = toc    
...
save('test-eps-l1.txt', 'M', '-ascii', '-tabs')
...
axis tight;
set(h,'LineWidth',3);
saveas(h, 'test_eps_lone_cnt.eps', 'epsc');
hold off
...
axis tight;
set(h,'LineWidth',3);
saveas(h, 'test_eps_lone_time.eps', 'epsc');
hold off
