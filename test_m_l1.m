...
for i=1:30
    ...
    tic
    [r, f_energy, cnt1] = LoneSolve(B, d, .01, 0);
    t1 = toc;

    tic
    [r, f_energy, cnt2] = LoneSolve(B, d, .01, 1);
    t2 = toc;
...
save('test-m-l1.txt', 'M', '-ascii', '-tabs')
...
axis tight;
set(h,'LineWidth',3);
saveas(h, 'test_m_lone_cnt.eps', 'epsc');
hold off
...
axis tight;
set(h,'LineWidth',3);
saveas(h, 'test_m_lone_time.eps', 'epsc');
hold off
